...
const Home = () => (
  <main>
    <Container id="landing-page" className="py-3">
      {' '}
      {/* Wrap Row with a non-fluid Container for margins */}
      <Row className="align-middle text-center">
        <Col xs={4}>
          <PeopleFill size={100} />
          <h1>Multiple Users</h1>
          <h5>
            This address book enables any number of users to register and save their business contacts. You can only see
